...
class Picture(Totem):
    ...
    def run(self):
        if self.args.img:
            resize_image(self.args.img, 'images/image_resized.jpg')
            image = Image.open('images/image_resized.jpg')
            self.matrix.SetImage(image.convert('RGB'))
        elif self.args.gif:
            resize_gif(self.args.gif, 'images/gif_resized.gif')

            gif = Image.open('images/gif_resized.gif')
